...
// gewählten Ordner fehlt. Danach gilt die Datei im Ordner (nur gelesen).
// questions und infoMd je Factsheet dienen auch als Fallback, wenn eine
// bestehende model.json diese Felder (noch) nicht enthält.
  ...
  "factsheets": [
    {
      ...
      "milestone": "MS10",
      "external": false,
      "hint": "Klassifikation, Prüftiefe, relevante Factsheets",
      "factsheetDoc": "factsheets/ms10-foundation/factsheet-foundation.docx",
      "evidenceDoc": "projekte/{slug}/ms10-foundation.docx",
      "description": "Erste Prüfung auf Basis des Factsheets Foundation (Bezug: Community IT Strategie, architekturelle Klassifikation). Beantwortet: Ist das Projekt architekturrelevant? Welche Klassifikation? Welche Prüftiefe? Welche weiteren Factsheets sind im Projekt zu prüfen? Das Ergebnis wird auf dem OnePager dokumentiert.",
      "infoMd": "# Factsheet Foundation\n\n*Dummy — Struktur zur Diskussion, Fachinhalt folgt.*\n\n## Zweck\n\nErste Prüfung bei MS10. Entscheidet, ob das Projekt architekturrelevant ist, welche Architekturklassifikation es hat, welche Prüftiefe notwendig ist und welche weiteren Factsheets im Projekt geprüft werden müssen. Bezug: Community IT Strategie → architekturelle Klassifikation.\n\n## Vorgaben\n\n- Kriterien für Architekturrelevanz *(folgt)*\n- Definition der Architekturklassen *(folgt)*\n- Zuordnung Klassifikation → Prüftiefe: **S = 5 PT, M = 10 PT, L = 15 PT**\n- Zuordnung Klassifikation → relevante Factsheets *(folgt)*\n\n## Ergebnis für den OnePager\n\nArchitekturrelevanz, Klassifikation, Prüftiefe, Liste der zu prüfenden Factsheets.\n"
    },
    {
      ...
      "milestone": "MS20",
      "external": false,
      "hint": "z. B. SCHUBAN → Datenhaltungsvorgaben",
      "factsheetDoc": "factsheets/ms20-datenklassifikation/factsheet-datenklassifikation.docx",
      "evidenceDoc": "projekte/{slug}/ms20-datenklassifikation.docx",
      "description": "Einstufung der Daten (z. B. SCHUBAN) und daraus abgeleitete Datenhaltungsvorgaben (Schutzbedarfsanalyse).",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "D1",
    ...
    },
    {
      ...
      "milestone": "MS20",
      "external": false,
      "hint": "Schutzklasse, Conditions",
      "factsheetDoc": "factsheets/ms20-datenhaltung/factsheet-datenhaltung.docx",
      "evidenceDoc": "projekte/{slug}/ms20-datenhaltung.docx",
      "description": "Prüfung der Datenhaltung nach Factsheet Datenhaltung: Relevanz (Schritt 1), Einstufung mit Schutzklasse K0–K4 (Schritt 2), technische Angaben zu Ort, Umgebung und Backup (Schritt 3), Abweichungen und Risikoakzeptanz (Schritt 4), Gesamtergebnis (Schritt 5).",
      "questionsTitle": "Schritt 1 – Betrifft uns das?",
      "questions": [
        {
          "id": "S1",
        ...
        },
        {
          ...
          "kind": "text",
          "milestone": "MS20",
          "hint": "Name und Ort des Bestands, z. B. Applikation, Datenbank, SaaS-Lösung."
        },
        {
          "id": "E3",
        ...
        },
        {
          ...
          "kind": "text",
          "milestone": "MS20",
          "hint": "Einstufung nach Factsheet Datenhaltung; Begründung in den Bemerkungen."
        }
      ],
    ...
    },
    {
      ...
      "name": "Integrations- und Applikationsarchitektur",
      "milestone": "MS20",
      "external": false,
      "hint": "z. B. Kontextdiagramm",
      "factsheetDoc": "factsheets/ms20-integrations-applikationsarchitektur/factsheet-integrations-applikationsarchitektur.docx",
      "evidenceDoc": "projekte/{slug}/ms20-integrations-applikationsarchitektur.docx",
      "description": "Integrations- und Applikationsarchitektur; Ergebnis z. B. Kontextdiagramm als Lieferobjekt.",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "I1",
    ...
    },
    {
      ...
      "name": "Cloud- und Infrastrukturarchitektur",
      "milestone": "MS20",
      "external": false,
      "hint": "",
      "factsheetDoc": "factsheets/ms20-cloud-infrastrukturarchitektur/factsheet-cloud-infrastrukturarchitektur.docx",
      "evidenceDoc": "projekte/{slug}/ms20-cloud-infrastrukturarchitektur.docx",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "C1",
    ...
    },
    {
      ...
      "milestone": "MS20",
      "external": true,
      "hint": "Erstellung/Prüfung durch zuständige Stelle",
      "factsheetDoc": "factsheets/ms20-security-compliance/factsheet-security-compliance.docx",
      "evidenceDoc": "projekte/{slug}/ms20-security-compliance.docx",
      "description": "Wird nicht von uns erstellt, sondern zur Erstellung/Prüfung an die zuständige Stelle übergeben; hier nur Verweis und Übergabe.",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "SC1",
    ...
    },
    {
      ...
      "external": false,
      "hint": "",
      "factsheetDoc": "factsheets/ms20-idm-iam/factsheet-idm-iam.docx",
      "evidenceDoc": "projekte/{slug}/ms20-idm-iam.docx",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "A1",
    ...
    {
      "id": "operations",
      "name": "Betriebsarchitektur",
      "milestone": "MS40",
      "external": false,
      "hint": "",
      "factsheetDoc": "factsheets/ms40-betriebsarchitektur/factsheet-betriebsarchitektur.docx",
      "evidenceDoc": "projekte/{slug}/ms40-betriebsarchitektur.docx",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "B1",
    ...
    },
    {
      ...
      "external": false,
      "hint": "",
      "factsheetDoc": "factsheets/ms40-dokumentation/factsheet-dokumentation.docx",
      "evidenceDoc": "projekte/{slug}/ms40-dokumentation.docx",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "DO1",
    ...
    {
      "id": "technical-debt",
      "name": "Technische Schulden / Risiken / Conditions",
      "milestone": "MS40",
      "external": false,
      "hint": "Budget zur Behebung: Low / Med / High",
      "factsheetDoc": "factsheets/ms40-technische-schulden/factsheet-technische-schulden.docx",
      "evidenceDoc": "projekte/{slug}/ms40-technische-schulden.docx",
      "description": "Technische Schulden, Risiken und Conditions inkl. Budget zur Behebung (Low / Med / High).",
      "questionsTitle": "Leitfragen (Dummy — Fachinhalt folgt)",
      "questions": [
        {
          "id": "T1",
