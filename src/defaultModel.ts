...
export const DEFAULT_MODEL: Model = {
  ...
  "themes": [
    ...
    },
    {
      ...
      "infoMd": "# Cloud- und Infrastrukturarchitektur\n\n*Zweck und Prüffragen ausformuliert (Entwurf Claude, 02./07.09.2026) — Detailregeln noch offen, brauchen Fachinput.*\n\n## Zweck\n\nPrüft die Wahl der Zielumgebung und Plattform sowie die Einhaltung der Infrastrukturvorgaben, inklusive der damit verbundenen Betriebsaspekte.\n\n## Vorgaben\n\n- Strategie-Leitplanke: «Cloud First im Workplace, risikoorientiert bei Kernbankenapplikationen» (IT-Strategie 2027–2030)\n- Zielumgebung und Plattformwahl (Betreiber, Plattform, Standort, dediziert/geteilt, Umgebungen)\n- Verantwortung je Plattformkomponente (Bereitstellung, Betrieb, Patching)\n- Sizing auf erhobener Basis, Resilienz (Ausfall einer Komponente, RTO/RPO), Infrastructure as Code\n- Exit-Szenario: siehe Thema Security & Compliance (M20E3)\n- Weitere Detailregeln noch offen — brauchen Fachinput\n\n## Ergebnis für den OnePager\n\nEine Zeile: relevant / geprüft / Ergebnis / Risiken, Conditions, offene Punkte."
    },
    {
      "id": "security-compliance",
      "title": "Security & Compliance",
      "infoMd": "# Security & Compliance\n\n*Zweck und Prüffragen ausformuliert (Entwurf Claude, 02./07.09.2026) — Übergabeliste und Kriterien der Gate-Fragen mit der Fachstelle abstimmen.*\n\n## Zweck\n\nWird nicht von der Architekturprüfung selbst erstellt oder inhaltlich beurteilt, sondern an die zuständige Fachstelle übergeben. Hier wird die Übergabe dokumentiert (an wen, wann, mit welcher Übergabeliste), das Ergebnis der externen Prüfung samt Auflagen entgegengenommen.\n\nZusätzlich prüft die Architektur die dokumentarischen Compliance-Voraussetzungen, die sie ohne Security-Fachwissen beurteilen kann — heute das Exit-Szenario bei ausgelagerten oder Cloud-basierten Plattformen.\n\n## Vorgaben\n\n- Übergabe an die zuständige Stelle mit Übergabeliste («Architektur liefert / Security prüft»)\n- Ergebnis der externen Prüfung entgegennehmen, Auflagen als Conditions führen\n- Vor Produktivsetzung (M40): verlangte Security-Nachweise liegen vor, Auflagen erfüllt\n- Exit-Szenario bei ausgelagerten/Cloud-Plattformen (Outsourcing-Vorgaben)\n\n## Ergebnis für den OnePager\n\nEine Zeile: relevant / geprüft / Ergebnis / Risiken, Conditions, offene Punkte.\n",
      "handover": {
        "to": "",
        "subject": "Architekturprüfung «{{projekt}}» — Review {{thema}} für {{ms}}",
        "body": "Guten Tag\n\nFür das Projekt «{{projekt}}» bitten wir um den Review {{thema}} zum Meilenstein {{meilenstein}}.\nDie Architektur liefert die Ausgangslage (Datenklassifikation, Datenhaltung, Zielplattform, Integration, IAM-Muster); Security prüft Härtung, Verschlüsselung, Zugriffsschutz, Software-Supply-Chain, Threat Model und die regulatorischen Anforderungen.\n\nTermin: {{termin}}\n\n{{projektblock}}\n\n{{ausloeser}}\n\n{{ausgangslage}}\n\nBitte meldet uns Ergebnis und Auflagen zurück — wir tragen sie in die Architekturprüfung ein.\n\nVielen Dank!",
        "context": [
          "D0",
          "E1",
          "T1",
  ...
  "questions": [
    ...
    {
      "id": "SC1",
      "text": "Wurde das Vorhaben der Fachstelle Security & Compliance übergeben — an wen, wann, mit welcher Übergabeliste (was liefert die Architektur, was prüft Security)?",
      "milestone": "M20",
    ...
    {
      "id": "SC10",
      "text": "Liegt das Ergebnis der Fachstelle vor — mit Auflagen, die als Conditions übernommen sind?",
      "milestone": "M20",
      "themeId": "security-compliance",
      "remarksAlwaysOpen": true,
      "hint": "Ergebnis, Datum und die Auflagen der Fachstelle in den Bemerkungen festhalten; Auflagen mit Termin gehören zusätzlich in die Conditions des OnePagers bzw. ins Thema Technische Schulden / Risiken / Conditions."
    },
    {
      "id": "CI5",
      "themeId": "security-compliance",
    ...
    },
    {
      ...
      "milestone": "M10",
      "themeId": "security-compliance",
      "hint": "Z. B. neue externe Integrationen, neue Identity-/Access-Anbindungen. Entwurf — Formulierung und Kriterienliste mit Security & Compliance abstimmen. Löst bei Ja die Übergabe an die zuständige Stelle aus (s. M20E1)."
    },
    {
      "id": "SC2",
      ...
      "milestone": "M10",
      "themeId": "security-compliance",
      "hint": "Z. B. neue Datenflüsse, neue Speicherorte/-systeme, neue Verarbeitungszwecke. Entwurf — Formulierung und Kriterienliste mit Security & Compliance abstimmen. Löst bei Ja die Übergabe an die zuständige Stelle aus (s. M20E1)."
    },
    {
      "id": "SC3",
      ...
      "milestone": "M10",
      "themeId": "security-compliance",
      "hint": "Z. B. FINMA-Vorgaben, DSG. Entwurf — Formulierung und Kriterienliste mit Security & Compliance abstimmen. Löst bei Ja die Übergabe an die zuständige Stelle aus (s. M20E1)."
    },
    {
      "id": "SC12",
      "themeId": "security-compliance",
      ...
      "hint": "Ergebnis entgegennehmen, kein Inhaltsurteil: Welche Nachweise die Fachstelle vor PROD verlangt hat (M20E2), ob sie vorliegen und ob die Auflagen erledigt sind. Nachweise, die erst auf einer Testumgebung möglich sind, gehören als Auflage mit Gate vor die Produktivsetzung.",
      "remarksAlwaysOpen": true
    }
  ],
